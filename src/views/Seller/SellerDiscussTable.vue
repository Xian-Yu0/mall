...
import { SellerGetMyDiscussAPI, SellerCreateDiscussAPI } from '@/apis/Seller';
...
const createDiscuss = async () => {
  ...
  // const temp = await SellerCreateDiscussAPI(account, date, title, content);
...
const getMyDiscussNum = async () => {
  const account = sellerInfo.account;
  const temp = await SellerGetMyDiscussAPI(account)
...
const enterDiscuss = (DiscussId) => {
  router.push(`/SellerDiscuss/${DiscussId}`)
}
...
<template>
    ...
    <el-card shadow="hover" style="width: 100%">
      <el-row>
        <el-col :span="9">
          ...
          <img src="../../assets/DemoPic/user.png" alt=""
            style="width: 100px; height: 100px; margin-top: 15px; margin-left: 30px">
        </el-col>
        <el-col :span="10" :offset="1">
          <el-descriptions :column="1" style="margin-top: 15px;">
            <el-descriptions-item label="账号">{{ sellerInfo.account }}</el-descriptions-item>
            <el-descriptions-item label="用户名">{{ sellerInfo.nickname }}</el-descriptions-item>
  ...
  <el-row style="margin: 0px auto; width: 80%;">
    <el-col :span="16">
      <el-input placeholder="查找相关帖子" prefix-icon="el-icon-search" v-model="searchInput" style="height: 40px;">
      </el-input>
    </el-col>
    <el-col :span="2" style="margin-left: 25px;">
      <el-button type="primary" @click="searchDiscuss" style="height: 40px;">
        搜索帖子
      </el-button>
    </el-col>
    <el-col :span="2" style="margin-left: 10px;">
      <el-button type="primary" @click="searchMyDiscuss" style="height: 40px;">
        查看我的帖子
      </el-button>
    </el-col>
    <el-col :span="2" style="margin-left: 40px;">
      <el-button type="primary" @click="getDiscussList" style="height: 40px;">
        查看全部帖子
      </el-button>
    </el-col>
  </el-row>
