            ...
            <div class="goods-article">
              ...
              <!-- <div class="goods-tabs">
                ...
                <div class="goods-detail"> -->
                  <!-- 属性 -->
                  <!-- <ul class="attrs">
                    <li v-for="item in detail.details.properties" >
                      <span class="dt">{{ item.name }}</span>
                      <span class="dd">{{ item.value }}</span>
                    </li>
                  </ul> -->
                  <!-- 图片 -->
                   <!-- v-for写在哪个标签里，就循环创造哪个标签 -->
                   <!-- <img v-for="item in detail.details.pictures" :src="item" alt=""> -->
                <!-- </div>
              </div> -->
            </div>
            <!-- 24热榜+专题推荐 -->
